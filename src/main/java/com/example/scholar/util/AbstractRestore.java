...
public class AbstractRestore {
    public static String restoreAbstract(String jsonString){
        try {
            // 使用 Gson 解析 JSON
            Gson gson = new Gson();
            ...
            return restoredAbstract.toString().trim();
        }catch (Exception e){
            return "";
        }
    }
    public static void main(String[] args) {
        ...
        String res = restoreAbstract(jsonString);

        // 输出复原的文本
        System.out.println(res); // 去掉末尾空格
    }
}
